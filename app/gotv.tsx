...
export default function DSTVScreen() {
  ...
  const fetchPlans = async () => {
    setIsLoading(true);
    try {
      const response = await ApiClient.get('/payscribe/bouquets?service=gotv');
      if (response.success) {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.brandSection}>
        <Image 
          source={require("../assets/networks/gotv-logo.png")}
        ...
        <View style={styles.brandInfoSection}>
          <View style={styles.brandHeader}>
            <View style={styles.brandTitleContainer}>
              <Image 
                source={require("../assets/networks/gotv-small.png")}
