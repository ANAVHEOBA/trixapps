...
interface Plan {
  ...
  export default function AirtelScreen() {
      ...
      <View style={styles.container}>
        ...
        <ScrollView style={styles.scrollContainer} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.aboutSection}>
            <Text style={styles.aboutTitle}>About Airtel</Text>
            <Text style={styles.description}>
              Airtel is one of Africa's leading mobile network providers, offering reliable connectivity 
